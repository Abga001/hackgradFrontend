...
const ImprovedDashboard = () => {
  ...
  // Use direct fetch like in SearchResults with extended user data
  useEffect(() => {
    const fetchAll = async () => {
      ...
      try {
        ...
        // Get all contents with no pagination (careful with large datasets)
        const contentsResponse = await fetch(`http://localhost:3000/api/contents?page=${currentPage}&limit=${itemsPerPage}`, {
    ...
    fetchAll();
  }, [refreshCounter, currentPage, itemsPerPage]);
  ...
  return (
    <div className="dashboard">
      ...
      {/* Debug information - need to uncomment when needed */}
      {/* 
      ...
      */}
      ...
      {/* Debug menu with database info - need to uncomment when troubleshooting */}
      {/*
